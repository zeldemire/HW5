...
public:
    ...
    */
    ...
    /** \brief Create a blank image (to be filled-in)
        ...
        \see getImage
    */
    void create(int width, int height) throw(std::runtime_error);
    ...
    */
    void write(const std::string& fileName) throw(std::runtime_error);
...
protected:
    ...
    */
    void open(const char* fileName) throw(std::runtime_error);
    ...
    */
    ...
    /** Refactored method to open and validate PNG header.
        ...
        throws an exception.
    */
    FILE* validateHeader(const char* fileName) throw(std::runtime_error);
